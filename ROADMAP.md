<!-- v1.0.2 (2026-08-05) ROADMAP.md -->
# ROADMAP — Rust4ui

> Оформление — по канону `logs-md-files` (универсальный скилл): только `[ ]`/`[x]`, выполненный пункт падает в `[x]` текущей версии.

> JSON → UI → Rust. Быстрое прототипирование интерфейсов на egui.

---

### v*.* — Инструменты и локали
...
### v*.* — Продвинутые виджеты

- [ ] Темы
  - [ ] `themes/nord.json`
  - [ ] `themes/gruvbox.json`

### v*.* - Расширяем функционал
...
### v0.5 — Числовое поле, оставшиеся виджеты и полировка *(завершена)*
