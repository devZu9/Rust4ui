...
При проектировании словаря виджетов автор вдохновлялся сторонним проектом [EFx](https://github.com/ZhukMax/efx). Никакой технической зависимости от EFx нет — проект EFx не имеет отношения к Rust4ui.
