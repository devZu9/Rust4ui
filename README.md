...
При проектировании словаря виджетов автор вдохновлялся проектом [EFx](https://github.com/ZhukMax/efx). Имена тегов и базовых атрибутов частично пересекаются — переход между проектами интуитивно понятен. Никакой технической зависимости от EFx нет.
