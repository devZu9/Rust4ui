...
При проектировании Rust4ui использовался устоявшийся дизайн-словарь имён виджетов, общий с проектами на egui. Проект [EFx](https://github.com/ZhukMax/efx) послужил источником вдохновения для этого словаря. Технической зависимости от EFx нет — все виджеты реализованы на Rust4ui самостоятельно.
