...
## 9. Code Generator (JSON → EFx / Rust)
...
| `RadioGroup` | Радиопереключатели | ✅ |
| `Spinner` | Индикатор загрузки | ✅ |
| `Shortcut` | Глобальные горячие клавиши | ✅ |
| `ColorPicker` | Палитра цвета | ✅ |
| `MenuItem` / `SubMenu` | Пункты контекстного меню | ✅ |
| `MenuBar` / `Menu` | Панель меню | ✅ |
| `Notifications` | Зона уведомлений | ✅ |
| `Tray` | Системный трей | ✅ (v0.4) |
| `IconBar` | Панель иконок | ✅ |
| `IconButton` | Кнопка-иконка | ✅ |
| `Caption` | Короткая надпись | ✅ |
| `Indicator` | Цветная точка | ✅ |
| `StatusBar` | Строка состояния | ✅ |

### 15.3. Семантическая карта
